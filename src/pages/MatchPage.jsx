  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
        ...
        {/* Chat del partido (solo creador y jugadores confirmados) */}
        {(isCreator || isJoined) && (
          <Link
            to={`/partido/${slug}/chat`}
            className="flex items-center gap-3 bg-white rounded-2xl shadow-sm border border-gray-100 px-6 py-4 hover:border-green-200 hover:shadow-md transition-all"
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-gray-800 text-sm">Chat del partido</p>
              <p className="text-xs text-gray-400">Solo para jugadores confirmados</p>
            </div>
